...
class Test0001BxtToken(unittest.TestCase):
    def setUp(self):
        ...
        self.token_payload = {"exp": 1725600900, "iat": 1725600000, "iss": "bxtd", "kind": "access_token", "storage": "bearer", "username": "bxtuser" }
        self.refresh_payload = {"exp": 1726600000, "iat": 1725600000, "iss": "bxtd", "kind": "refresh_token", "storage": "bearer", "username": "bxtuser"}
